...
public class ProjectController extends Controller {
    ...
    public List<Database> getDatabaseList() {
        ...
        if (databaseList == null || databaseList.size() != databaseMap.size()) {
            databaseList = databaseMap.values().stream().sorted((d, b) -> Integer.compare(d.getId(), b.getId())).collect(Collectors.toList());
        }
        return databaseList;
    }
    ...
    public List<SFTP> getSftpList() {
        ...
        if (sftpList == null || sftpList.size() != sftpMap.size()) {
            sftpList = sftpMap.values().stream().sorted((d, b) -> Integer.compare(d.getId(), b.getId())).collect(Collectors.toList());
        }
        return sftpList;
    }
    ...
    public List<Local> getLocalList() {
        ...
        if (localList == null || localList.size() != localMap.size()) {
            localList = localMap.values().stream().sorted((d, b) -> Integer.compare(d.getId(), b.getId())).collect(Collectors.toList());
        }
        return localList;
    }
